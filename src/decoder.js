...
const TESTNET_NODE = 'https://api.nileex.io'

// const MAINNET_NODE = 'https://api.tronex.io';
// const TESTNET_NODE = 'https://testhttpapi.tronex.io'
...
class TronTxDecoder {
    ...
    async decodeRevertMessage(transactionID) {
        ...
        try {
            ...
            let txStatus = (transaction.ret && transaction.ret[0] && transaction.ret[0].contractRet) ? transaction.ret[0].contractRet : undefined;
            
            if (txStatus === undefined) throw 'No txStatus'
